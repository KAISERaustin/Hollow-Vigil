...
func run() -> void:
	...
	check(screen.board.selected == second and screen.board.selected_tower == screen.run.tower_at(second) and not screen.tower_dialog.visible, "Selecting another tower replaces interaction owner")
