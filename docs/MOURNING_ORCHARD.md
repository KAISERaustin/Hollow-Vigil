...
- The first patch cell holds its only portal. All other Orchard cells have connecting roads and four build pads without a spawn timer or traffic purchase.
