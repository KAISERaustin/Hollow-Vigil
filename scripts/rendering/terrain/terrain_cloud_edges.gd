...
const Clouds = preload("res://scripts/rendering/terrain/terrain_clouds.gd")
...
func _draw() -> void:
	...
	var half := Balance.TILE * 0.5
	for id in preload("res://scripts/rendering/terrain/region_query.gd").in_view(borders_by_region, view, half):
