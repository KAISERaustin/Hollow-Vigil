...
const TUNING_FIELDS := {
	...
	"gear": {
		...
		"duration": {"label":"Effect duration","suffix":" s","min":0,"max":60,"step":0.1},
		"boss_duration": {"label":"Boss effect duration","suffix":" s","min":0,"max":60,"step":0.1},
		"fire_damage": {"label":"Fire damage (0 off, 1 on)","suffix":"","min":0,"max":1,"step":1,"integer":true},
		"blast_radius": {"label":"Minimum blast radius","suffix":" units","min":0,"max":500,"step":1},
		"push_distance": {"label":"Knockback distance","suffix":" units","min":0,"max":200,"step":1},
		"push_immunity": {"label":"Knockback immunity","suffix":" s","min":0,"max":60,"step":0.1},
		"stun_immunity": {"label":"Stun immunity","suffix":" s","min":0,"max":60,"step":0.1},
		"fork_count": {"label":"Extra bolt count","suffix":"","min":0,"max":20,"step":1,"integer":true},
		"fork_radius": {"label":"Extra bolt search radius","suffix":" units","min":0,"max":500,"step":1},
		"fork_multiplier": {"label":"Extra bolt damage","suffix":"× base damage","min":0,"max":20,"step":0.05},
		"health_threshold": {"label":"Target health threshold","suffix":"%","min":0,"max":100,"step":1},
		"slow_percent": {"label":"Movement slow","suffix":"%","min":0,"max":100,"step":1},
		"vulnerability_percent": {"label":"Extra damage received","suffix":"%","min":0,"max":200,"step":1},
		"opening_attacks": {"label":"Fast opening attacks","suffix":"","min":0,"max":100,"step":1,"integer":true},
		"opening_speed": {"label":"Opening attack speed bonus","suffix":"%","min":0,"max":200,"step":1},
		"reset_timeout": {"label":"Opening reset timeout","suffix":" s","min":0.1,"max":120,"step":0.1},
		...
		"stack_limit": {"label": "Maximum stacks", "suffix": "", "min": 0.0, "max": 100.0, "step": 1.0, "integer": true},
	...
	"towers": {
		...
		"projectile_width": {"label": "Projectile hit radius", "suffix": " units", "min": 1, "max": 60, "step": 1},
		"volley_count": {"label": "Parallel bolts", "suffix": "", "min": 1, "max": 9, "step": 1,"integer":true},
		"volley_spacing": {"label": "Bolt spacing", "suffix": " units", "min": 0, "max": 60, "step": 1},
		"return_speed": {"label": "Return speed multiplier", "suffix": "×", "min": 0.1, "max": 5, "step": 0.1},
		"vulnerability_percent": {"label": "Extra damage received", "suffix": "%", "min": 0, "max": 200, "step": 1},
		"mark_duration": {"label": "Mark duration", "suffix": " s", "min": 0.1, "max": 60, "step": 0.1},
		"mark_spread_count": {"label": "Spread recipients", "suffix": "", "min": 0, "max": 20, "step": 1,"integer":true},
		"mark_spread_radius": {"label": "Mark spread reach", "suffix": " units", "min": 0, "max": 300, "step": 1},
		"boss_damage_multiplier": {"label": "Boss damage multiplier", "suffix": "×", "min": 1, "max": 5, "step": 0.05},
		"trap_capacity": {"label": "Stored traps", "suffix": "", "min": 1, "max": 30, "step": 1,"integer":true},
		"trap_duration": {"label": "Trap lifetime", "suffix": " s", "min": 0.1, "max": 60, "step": 0.1},
		"trap_arm_time": {"label": "Trap arming delay", "suffix": " s", "min": 0.1, "max": 10, "step": 0.1},
		"trap_count": {"label": "Traps per deployment", "suffix": "", "min": 1, "max": 9, "step": 1,"integer":true},
		"trap_radius": {"label": "Trap trigger radius", "suffix": " units", "min": 1, "max": 40, "step": 1},
