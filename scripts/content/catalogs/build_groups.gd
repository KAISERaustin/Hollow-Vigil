...
const OPTIONS := {
	...
	"layout": {"name": "Tower layout and equipment", "description": "Placed towers, upgrades, equipment, for the selected levels.", "campaign_name": "Tower layout and equipment", "campaign_description": "Placed towers, upgrades, and equipment for the selected levels."}
}
const DEFINITIONS := {
