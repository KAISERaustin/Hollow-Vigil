...
const PROFILES := {
	"forest": {"landmarks": ["watchtower", "watermill", "ruins", "watchtower"], "scenery": ["pines", "pines", "pool"], "stone": "d4ccb0", "roof": "48695c", "water": "699b99", "motif": "leaf"},
	"ashen_forge": {"landmarks": ["foundry", "fortress", "foundry", "ruins"], "scenery": ["crags", "crags", "slag"], "stone": "cba58b", "roof": "655952", "water": "b96345", "motif": "anvil"},
	...
	"castle_ruin": {"landmarks": ["fortress", "ruins", "watchtower", "fortress"], "scenery": ["crags", "ruins", "cypress"], "stone": "bcb8ad", "roof": "515663", "water": "546777", "motif": "shield"},
