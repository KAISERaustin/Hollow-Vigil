...
func movement_speed(_enemy: Dictionary, _now: float, tuning: Dictionary = {}, resolved: Dictionary = {}) -> float:
	return (definition(tuning) if resolved.is_empty() else resolved).speed
