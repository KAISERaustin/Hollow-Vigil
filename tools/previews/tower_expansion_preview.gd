...
const Art = preload("res://tools/previews/tower_expansion/concept_art.gd")
const Data = preload("res://tools/previews/tower_expansion/concept_data.gd")
const A = preload("res://scripts/rendering/terrain/terrain_art.gd")
const UI = preload("res://scripts/ui/shared/interface.gd")
const OUTPUT := "res://artifacts/tower-expansion/"
