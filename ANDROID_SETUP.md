...
Bundletool validation and JAR signature verification passed. The manifest declares version code 13, version name 1.1.3, portrait orientation and a non-resizable activity. Google Play retained warnings for absent deobfuscation and native debug-symbol files. Release scripts, scenes, tests and client configuration (793 files) matched main.

Bundle: `/private/tmp/hollow-vigil-release-1.1.3-source/exports/hollow-vigil-1.1.3.aab`. Logs: ignored `artifacts/release-1.1.3/`.
