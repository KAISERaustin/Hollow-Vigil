...
try {
    ...
    & $GodotPath --headless --path $PSScriptRoot --export-release Android 'exports/hollow-vigil-1.1.4.aab' --quit *> artifacts/android-export.log
    ...
    Get-Item 'exports/hollow-vigil-1.1.4.aab'
} finally {
