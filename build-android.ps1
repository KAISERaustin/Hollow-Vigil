...
try {
    ...
    & $GodotPath --headless --path $PSScriptRoot --export-release Android 'exports/hollow-vigil-0.1.0.aab' --quit *> artifacts/android-export.log
    ...
    Get-Item 'exports/hollow-vigil-0.1.0.aab'
} finally {
